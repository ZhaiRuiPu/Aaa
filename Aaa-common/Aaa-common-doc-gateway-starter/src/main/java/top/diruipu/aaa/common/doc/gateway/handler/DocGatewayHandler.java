package top.diruipu.aaa.common.doc.gateway.handler;
...
/**
 * @author diruipu
 * @create 2021-12-21 8:42 PM
 * @ClassName DocGatewayHandler
 */
public class DocGatewayHandler {

    private SecurityConfiguration securityConfiguration;
    private UiConfiguration uiConfiguration;
    private SwaggerResourcesProvider swaggerResources;
    private DocGatewayProperties properties;
    ...
    public void setProperties(DocGatewayProperties properties) {
